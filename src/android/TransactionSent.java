...
public class TransactionSent extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(getApplication().getResources().getIdentifier("transaction_sent_islamic", "layout", packageName));
            ...
            Log.e(TAG, "Error in TransactionSent OnCreate: " + e.toString(), e);
        }
    }
    ...
    private void fetchCardData(String cardID) {
        try {
            ...
            TokenizationIslamic tokenizationIslamic = TokenizationIslamic.getInstance();
            d1Task = tokenizationIslamic.getD1Task();
            ...
            D1Task.Callback<CardMetadata> cardDataCallback = new D1Task.Callback<CardMetadata>() {
                ...
                public void onSuccess(CardMetadata cardMetadata) {
                    ...
                    Log.i(TAG, "Card metadata fetched successfully. Last 4 FPAN: " + last4FPAN);
